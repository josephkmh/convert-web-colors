...
describe("convert", () => {
    it("returns a populated object when given rgba() string: rgba(0,0,0,1)", () => {
        var object = converter.convert("rgba(0,0,0,1)");
        var expected = {
            rgba: "rgba(0, 0, 0, 1)",
            rgb: "rgb(0, 0, 0)",
            hsla: "hsla(0, 0%, 0%, 1)",
    ...
    it("returns a populated object when given hsla: hsla(270,50%,40%,1)", () => {
        var object = converter.convert("hsla(270,50%,40%,1)");
        var expected = {
    ...
    it("returns a populated object when given hsla: hsla(13,84.1%,12.5%,.35)", () => {
        var object = converter.convert("hsla(13,84.1%,12.5%,.35)");
        var expected = {
    ...
    it("returns a populated object when given a hex string with transparency #4c73b282", () => {
        var object = converter.convert("#4c73b282");
        var expected = {
    ...
    it("returns a populated object when given a hex string: #00FF00", () => {
        var object = converter.convert("#00FF00");
        var expected = {
            rgba: "rgba(0, 255, 0, 1)",
            rgb: "rgb(0, 255, 0)",
    ...
    it("returns a populated object when given rgb: 45,45,45", () => {
        var object = converter.convert("45,45,45");
        var expected = {
    ...
    it("returns a populated object when given hsl: 84, 72%, 57%", () => {
        var object = converter.convert("84, 72%, 57%");
        var expected = {
